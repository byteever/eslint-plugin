module.exports = {
    ...
    create( context ) {
         ...
         *
         * @typedef {string} PackageLocality
         */
         ...
         * property.
         *
         * @param {PackageLocality} locality Desired package locality.
         *
         ...
         *
         * @return {PackageLocality} Package locality.
         */
        ...
        /**
         * Tests if the locality is defined in the correct order (External, Internal).
         *
         * @param {espree.Node}       child    Node to test.
         * @param {PackageLocality} locality Package locality.
         * @param {PackageLocality} previousLocality Previous package locality.
         */
